...
<div class="max-w-2xl mx-auto px-6 py-12">
  ...
  <h1 class="text-3xl font-heading mb-8">Nouveau tag</h1>

  <form method="POST" action="{{ route('admin.tags.store') }}" class="glass rounded-3xl p-8 space-y-6">
    @csrf
    ...
    <div class="flex items-center gap-4">
      ...
      >
        <i class="fas fa-save"></i> Créer le tag
      </button>
      <a 
